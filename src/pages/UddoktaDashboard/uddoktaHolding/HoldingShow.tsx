...
import { useUddoktaAllHoldingQuery } from "@/redux/api/sonod/sonodApi";
...
const HoldingShow = () => {
  ...
  const { data, isFetching } = useUddoktaAllHoldingQuery({
    word,
    token,
    search: searchTerm,
    page: currentPage,
        ...
        <div className="">
          <div className="card-header">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div>
                <Link
                  to={`/uddokta/holding/list/add/${word}`}
                          ...
                          holdings.map((item: THolding) => (
                            <tr key={item.id}>
                              ...
                              <td>
                                ...
                                <Link
                                  to={`/uddokta/holding/list/view/${item.id}`}

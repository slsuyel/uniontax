...
import { useUddoktaSingleHoldingQuery } from "@/redux/api/sonod/sonodApi";
...
const SingleHolding = () => {
  ...
  const { data, isLoading } = useUddoktaSingleHoldingQuery({
    id,
    token,
  });
  ...
  return (
    <div className="card p-3 border-0">
      <Breadcrumbs
        className="mb-1"
        current={`${holding.category} এর হোল্ডিং ট্যাক্স`}
      />

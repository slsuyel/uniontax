        ...
        <div className={`${!isDashboard ? "container my-3" : ""}`}>
            ...
            >
                ...
                <div className="form-pannel">
                    <div className="row">
                        {sonodName == "উত্তরাধিকারী সনদ" && englishInheritanceForm(sonodName)}
                        {/* {sonodName == "উত্তরাধিকারী সনদ" && InheritanceForm(sonodName)} */}
                        {sonodName == "ওয়ারিশান সনদ" && englishInheritanceForm(sonodName)}
                        {sonodName == "বিবিধ প্রত্যয়নপত্র" && englishInheritanceForm(sonodName)}
                        {sonodName == "একই নামের প্রত্যয়ন" && englishInheritanceForm(sonodName)}

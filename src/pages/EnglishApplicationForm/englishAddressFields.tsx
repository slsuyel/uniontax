        ...
        <>
            <div className="row">
                <div className="col-md-6">
                    ...
                    <Form.Item></Form.Item>
                    <Form.Item name="current_division" label="Division">
                        <Select
                    ...
                    <Form.Item name="applicant_present_district" label="District">
                        <Select
                    ...
                    <Form.Item name="applicant_present_Upazila" label="Upazila/Thana">
                        <Select
                    ...
                    <Form.Item name="applicant_present_post_office" label="Post Office">
                        <Input className="form-control" />
                    </Form.Item>
                    <Form.Item name="applicant_present_word_number" label="Ward Number">
                    ...
                    <Form.Item name="applicant_present_village" label="Village/Neighborhood">
                        <Input className="form-control" />
                    </Form.Item>
                </div>
                ...
                <div className="col-md-6">
                    ...
                    <Form.Item name="applicant_permanent_post_office" label="Post Office">
                        <Input className="form-control" />
                    </Form.Item>
                    <Form.Item name="applicant_permanent_word_number" label="Ward Number">
                        <Select style={{ height: 40, width: "100%" }}>
                            <Option value="">Ward Number</Option>
                            {Array.from({ length: 9 }, (_, i) => (
                                <Option key={i + 1} value={i + 1}>
                    ...
                    <Form.Item name="applicant_permanent_village" label="Village/Neighborhood">
                        <Input className="form-control" />
                    </Form.Item>
                </div>
            </div>

                            ...
                            <div key={item.id} className="card mb-3">
                                <div className="card-body">
                                    ...
                                    {item?.holding_tax ? <>
                                        ...
                                        <>
                                            <p><strong>Maliker Name:</strong> {item.sonods?.applicant_name}</p>
                                            <p><strong>Gram:</strong> {item.sonods?.applicant_present_village}</p>
                                            <p><strong>Mobile No:</strong> {item.sonods?.applicant_mobile}</p>
                                            <p><strong>Holding No:</strong> {item.sonods?.applicant_holding_tax_number}</p>
                                        </>
                                    }
